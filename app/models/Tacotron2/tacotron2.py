...
class Tacotron2(nn.Module):
    def __init__(self, vocab_size, embedding_dim, hidden_dim, output_dim):
        ...
        self.decoder = Decoder(hidden_dim*4, hidden_dim , output_dim)
    ...
    def forward(self, x, device):
        ...
        mel_output, new_hidden_state, new_cell_state = self.decoder(decoder_input, attention_context)
        return mel_output, new_hidden_state, new_cell_state, attention_weights
